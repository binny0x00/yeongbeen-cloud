  ...
  <div v-if="hasExternalLinks || youtubeEmbedUrl" class="flex flex-col gap-8">
    <nav v-if="hasExternalLinks" aria-label="프로젝트 외부 링크" class="flex items-center gap-3">
      <a
        ...
        class="inline-flex size-11 items-center justify-center rounded-full border border-border bg-transparent text-ink-muted transition-colors hover:border-stroke-strong hover:text-ink focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-accent"
        title="GitHub 저장소"
      >
